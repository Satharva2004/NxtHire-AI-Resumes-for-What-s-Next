  ...
  return (
    <div class="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
      <div class="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_100%_200px,#d5c5ff,transparent)]">
        ...
        <section className="pt-12 sm:pt-16 absolute bottom-0 left-0 right-0 top-36">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 ">
            <div className="max-w-2xl mx-auto text-center">
              <h1 className="px-6 text-lg text-gray-600 font-inter">NxtHire - AI Resumes for What’s Next.</h1>
              <p className="mt-5 text-4xl font-bold leading-tight text-gray-900 sm:leading-tight sm:text-4xl lg:text-5xl lg:leading-tight font-pj">
              ...
              <p className="mt-8 text-base text-gray-500 font-inter">Get personalized career timelines, gamified achievements, ATS optimization, and predictive job matches all in one place.</p>
            </div>
          </div>
